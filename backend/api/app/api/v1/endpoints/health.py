...
@router.get("", summary="Health check básico", description="Verifica que la API esté funcionando")
...
@router.get(
    "/ready", summary="Readiness check", description="Verifica conectividad con dependencias (DB)"
)
