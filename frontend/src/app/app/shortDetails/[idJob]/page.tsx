  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[0.95fr_1.05fr]">
      <section className="rounded-2xl border border-white/10 bg-night-800/55 p-5 shadow-panel">
        <p className="text-xs uppercase tracking-[0.22em] text-neon-cyan/70">detalle del short</p>
      ...
      <section className="rounded-2xl border border-white/10 bg-night-800/55 p-5 shadow-panel">
        <p className="text-xs uppercase tracking-[0.22em] text-neon-magenta/70">acciones rapidas</p>
        ...
        <div className="mt-5 rounded-xl border border-white/10 bg-white/5 p-4 text-sm text-white/80">
          <p className="font-semibold text-white">Inspector</p>
